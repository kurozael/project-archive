...
--[[ Basic SWEP Information to display to the client. ]]--
	...
	SWEP.Purpose			= "A firearm used to harm beings." -- The purpose of the weapon. (Optional of course.)
	SWEP.Instructions		= "Press LMB to fire and R to reload." -- The instructions to use the weapon. (For dummies.)
	SWEP.Contact			= "Cloudsixteen.com" -- Where to go to get help. 
...
Thanks and Loves and Kisses, Zig.
]]--
