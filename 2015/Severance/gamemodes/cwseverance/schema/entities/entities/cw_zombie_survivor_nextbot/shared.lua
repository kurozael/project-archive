...
--[[-------------------------------------------------------------------------
TODO: Zombie Survivor Loot Table
SHOULD DROP: Lower end survival gear, stuff 'post apocalypse' and minor pre-apocalypse stuff
...
ENT.ZombieType = "Infected Survivor"
...
function ENT:AlertNearby(target, range, boNoise)
	...
	for k, v in pairs(ents.FindByClass("cw_zombie_*")) do
