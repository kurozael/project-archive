...
function PANEL:Populate(staffData)
	self:SetTitle("Staff Data");
	...
	function button.DoClick(button)
		datastream.StreamToServer( "ks_EditStaffData", string.sub(textEntry:GetValue(), 0, 500) );
...
-- Register the panel.
vgui.Register("ks_StaffData", PANEL, "DFrame");