...
function CONTROL:OnDraw()
	...
	draw.StyledBox(x + 2, y + 2, width - 4, 23, Color(0, 0, 0, 0.5), true);
	g_Render:DrawLine( x + 1, y + 23, x + width - 2, y + 23, Color(0, 0, 0, 1) );
	g_Render:DrawLine( x + 1, y + 24, x + width - 2, y + 24, Color(1, 1, 1, 1) );
end;
