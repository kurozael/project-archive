...
function PLUGIN:LoadPaper()
	local paper = Clockwork:RestoreSchemaData("plugins/paper/"..game.GetMap());
...
function PLUGIN:SavePaper()
	...
	Clockwork:SaveSchemaData("plugins/paper/"..game.GetMap(), paper);
end;

Clockwork:HookDataStream("EditPaper", function(player, data)
