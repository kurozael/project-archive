...
function ENT:SetItem(item, batch)
	local shipmentModel = CloudScript.option:GetKey("model_shipment");
...
function ENT:OnRemove()
	if (!CloudScript:IsShuttingDown() and self.inventory) then
		CloudScript.entity:DropItemsAndCash(self.inventory, nil, self:GetPos(), self);
