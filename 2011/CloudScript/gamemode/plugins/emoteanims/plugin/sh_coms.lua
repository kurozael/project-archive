...
function COMMAND:OnRun(player, arguments)
	...
	if (!player.nextStanceOrGesture or curTime >= player.nextStanceOrGesture) then
		...
		local modelClass = CloudScript.animation:GetModelClass( player:GetModel() );
		...
		if (modelClass == "civilProtection") then
			...
			elseif ( !forcedAnimation or !PLUGIN.stances[forcedAnimation.animation] ) then
				if ( player:Crouching() ) then
					CloudScript.player:Notify(player, "You cannot do this while you are crouching!");
				elseif ( player:IsOnGround() or IsValid( player:GetGroundEntity() ) ) then
					...
					CloudScript.player:Notify(player, "You must be standing on the ground!");
				end;
			end;
		else
			CloudScript.player:Notify(player, "The model that you are using cannot perform this action!");
		end;
	else
		CloudScript.player:Notify(player, "You cannot do another stance or gesture yet!");
	end;
end;

CloudScript.command:Register(COMMAND, "AnimThreat");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand(string.gsub(COMMAND.name, "Anim", ""), "Emotes", COMMAND.name);
end;
...
CloudScript.command:Register(COMMAND, "AnimMotion");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand( string.gsub(COMMAND.name, "Anim", ""), "Emotes", COMMAND.name, {"Left", "Right", "Behind"} );
end;
...
CloudScript.command:Register(COMMAND, "AnimDeny");
...
CloudScript.command:Register(COMMAND, "AnimCheer");
...
CloudScript.command:Register(COMMAND, "AnimWave");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand( string.gsub(COMMAND.name, "Anim", ""), "Emotes", COMMAND.name, {"Close", "Normal"} );
end;
			...
			elseif ( !forcedAnimation or !PLUGIN.stances[forcedAnimation] ) then
				if ( player:Crouching() ) then
					...
					if (traceLine.Hit) then
						...
						CloudScript.player:Notify(player, "You must be facing, and near a wall!");
					end;
				end;
			end;
		else
...
CloudScript.command:Register(COMMAND, "AnimPantWall");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand("Pant Wall", "Emotes", COMMAND.name);
end;
...
CloudScript.command:Register(COMMAND, "AnimWindow");
...
CloudScript.command:Register(COMMAND, "AnimPant");
...
CloudScript.command:Register(COMMAND, "AnimSit");
			...
			elseif ( !forcedAnimation or !PLUGIN.stances[forcedAnimation.animation] ) then
				if ( player:Crouching() ) then
					...
					if (traceLine.Hit) then
						...
						CloudScript.player:Notify(player, "You must be facing away from, and near a wall!");
					end;
				end;
			end;
		else
...
CloudScript.command:Register(COMMAND, "AnimSitWall");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand("Sit Wall", "Emotes", COMMAND.name);
end;
...
CloudScript.command:Register(COMMAND, "AnimIdle");
...
CloudScript.command:Register(COMMAND, "AnimLean");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand( string.gsub(COMMAND.name, "Anim", ""), "Emotes", COMMAND.name, { {"Arms Back", "ArmsBack"}, {"Arms Down", "ArmsDown"}, "Normal"} );
end;
...
CloudScript.command:Register(COMMAND, "AnimATW");

if (CLIENT) then
	CloudScript.quickmenu:AddCommand("Face Wall", "Emotes", COMMAND.name);
end;