...
CloudScript.animation = {};
CloudScript.animation.sequences = {};
CloudScript.animation.override = {};
CloudScript.animation.models = {};
CloudScript.animation.stored = {};
CloudScript.animation.convert = {
...
CloudScript.animation.holdTypes = {
	["gmod_tool"] = "pistol",
	["weapon_357"] = "pistol",
	["weapon_ar2"] = "smg",
	["weapon_smg1"] = "smg",
...
CloudScript.animation.stored.combineOverwatch = {
...
CloudScript.animation.stored.civilProtection = {
...
CloudScript.animation.stored.femaleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
...
CloudScript.animation.stored.maleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
	["crouch_grenade_aim_walk"] = ACT_WALK_CROUCH,
	["stand_grenade_aim_idle"] = ACT_IDLE,
...
function CloudScript.animation:SetMenuSequence(model, sequence)
	self.sequences[ string.lower(model) ] = sequence;
end;

-- A function to get a model's menu sequence.
function CloudScript.animation:GetMenuSequence(model, bRandom)
...
function CloudScript.animation:AddModel(class, model)
	local lowerModel = string.lower(model);
...
function CloudScript.animation:AddOverride(model, key, value)
	local lowerModel = string.lower(model);
...
function CloudScript.animation:GetForModel(model, key)
	local lowerModel = string.lower(model);
...
function CloudScript.animation:GetModelClass(model, alwaysReal)
...
function CloudScript.animation:GetTable(model)
	local lowerModel = string.lower(model);
...
CloudScript.animation:AddCombineOverwatchModel("models/combine_soldier_prisonguard.mdl");
CloudScript.animation:AddCombineOverwatchModel("models/combine_super_soldier.mdl");
CloudScript.animation:AddCombineOverwatchModel("models/combine_soldier.mdl");

CloudScript.animation:AddCivilProtectionModel("models/police.mdl");

CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_01.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_02.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_03.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_04.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_06.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group01/female_07.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_01.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_02.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_03.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_04.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_06.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group02/female_07.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_01.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_02.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_03.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_04.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_06.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03/female_07.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_01.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_02.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_03.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_04.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_06.mdl");
CloudScript.animation:AddFemaleHumanModel("models/humans/group03m/female_07.mdl");
  
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_01.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_02.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_03.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_04.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_05.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_06.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_07.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_08.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group01/male_09.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_01.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_02.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_03.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_04.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_05.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_06.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_07.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_08.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group02/male_09.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_01.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_02.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_03.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_04.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_05.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_06.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_07.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_08.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03/male_09.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_01.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_02.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_03.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_04.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_05.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_06.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_07.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_08.mdl");
CloudScript.animation:AddMaleHumanModel("models/humans/group03m/male_09.mdl");