...
CloudScript.cooldown = {};
CloudScript.cooldown.sizes = {};

-- A function to get a cooldown table.
function CloudScript.cooldown:GetTable(width, height, bAdd)
...
function CloudScript.cooldown:AddSize(width, height)
	local verticies = {
		{
...
function CloudScript.cooldown:DrawBox(x, y, width, height, progress, color, textureID, bCenter)
...
CloudScript.cooldown:AddSize(64, 64);
CloudScript.cooldown:AddSize(32, 32);