...
function PANEL:Rebuild()
	...
	for k, v in pairs(CloudScript.setting.stored) do
	...
	if (table.Count(categories) > 0) then
		local label = vgui.Create("cloud_InfoText", self);
			label:SetText("These settings are client-side to help you personalise CloudScript.");
...
vgui.Register("cloud_Settings", PANEL, "DFrame");