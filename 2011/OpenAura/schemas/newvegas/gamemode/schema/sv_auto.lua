...
for k, v in pairs( _file.Find("../materials/newvegas/*.*") ) do
	resource.AddFile("materials/newvegas/"..v);
end;
...
openAura.config:Add("intro_text_small", "What happens in Vegas... stays in Vegas.", true);
openAura.config:Add("intro_text_big", "NEW VEGAS, 2280.", true);
