...
function THEME:CreateFonts()
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(2048), 500, true, false, "veg_Large3D2D");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(31), 500, true, false, "veg_IntroTextSmall");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(24), 500, true, false, "veg_IntroTextTiny");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(36), 500, true, false, "veg_CinematicText");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(78), 500, true, false, "veg_IntroTextBig");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(24), 500, true, false, "veg_TargetIDText");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(126), 500, true, false, "veg_MenuTextHuge");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(78), 500, true, false, "veg_MenuTextBig");
	surface.CreateFont("Spranq eco sans", ScaleToWideScreen(20), 500, true, false, "veg_MainText");
...
function THEME:Initialize()
	openAura.option:SetColor( "information", Color(165, 155, 95, 255) );
...
local DIRTY_TEXTURE = surface.GetTextureID("newvegas/dirty2");
local SCRATCH_TEXTURE = surface.GetTextureID("newvegas/scratch2");
